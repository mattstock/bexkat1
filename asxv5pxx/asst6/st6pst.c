...
/*
 * 3-Bit Relocation Mode Definition
 *
 *	#define		R_3BIT	0100		Three Bit Mode
 */
...
/*
 * 5-Bit Relocation Mode Definition
 *
...
/*
 * 12-Bit Relocation Mode Definition
 *
 *	#define		R_CLJP	0300		12 Bit Mode
 */
char	mode3[32] = {	/* R_3BIT */
	'\214',	'\215',	'\216',	'\217',	'\200',	'\201',	'\202',	'\203',
	'\204',	'\205',	'\206',	'\207',	'\014',	'\015',	'\016',	'\017',
	'\020',	'\021',	'\022',	'\023',	'\024',	'\025',	'\026',	'\027',
	'\030',	'\031',	'\032',	'\033',	'\034',	'\035',	'\036',	'\037'
};
...
struct	mode	mode[4] = {
    ...
    {	&mode1[0],	1,	0x000000E0,	0x00000007	},
    {	&mode2[0],	1,	0x000000F8,	0x0000001F	},
    {	&mode3[0],	1,	0x0000F0FF,	0x00000FFF	}
};
...
/*    {	NULL,	".32bit",	S_BITS,		0,	O_4BYTE	},	*/
    ...
    {	NULL,	"call",		S_CLJP,		0,	0x0100	},
    {	NULL,	"jp",		S_CLJP,		0,	0x0900	},

    {	NULL,	"jrnz",		S_JR,		0,	0x00	},
    {	NULL,	"jrnc",		S_JR,		0,	0x02	},
    {	NULL,	"jrz",		S_JR,		0,	0x04	},
    {	NULL,	"jrc",		S_JR,		0,	0x06	},

    {	NULL,	"jrs",		S_JRB,		0,	0x13	},
    {	NULL,	"jrr",		S_JRB,		0,	0x03	},

    {	NULL,	"res",		S_BRS,		0,	0x0B	},
    {	NULL,	"set",		S_BRS,		0,	0x1B	},

    {	NULL,	"ld",		S_LD,		0,	0x07	},
    {	NULL,	"ldi",		S_LDI,		0,	0x07	},

    {	NULL,	"add",		S_AOP,		0,	0x47	},
    {	NULL,	"and",		S_AOP,		0,	0xA7	},
    {	NULL,	"cp",		S_AOP,		0,	0x27	},
    {	NULL,	"sub",		S_AOP,		0,	0xC7	},

    {	NULL,	"addi",		S_OPI,		0,	0x57	},
    {	NULL,	"andi",		S_OPI,		0,	0xB7	},
    {	NULL,	"cpi",		S_OPI,		0,	0x37	},
    {	NULL,	"subi",		S_OPI,		0,	0xD7	},

    {	NULL,	"dec",		S_BOP,		0,	0xE7	},
    {	NULL,	"inc",		S_BOP,		0,      0x67	},

    {	NULL,	"com",		S_INHA,		0,	0x2D	},
    {	NULL,	"rcl",		S_INHA,		0,	0xAD	},

    {	NULL,	"reti",		S_INH,	   	0,	0x4D	},
    {	NULL,	"stop",		S_INH,	   	0,	0x6D	},
    {	NULL,	"ret",		S_INH,		0,	0xCD	},
    {	NULL,	"wait",		S_INH,		S_EOL,	0xED	}
