...
/*
 *	#define		M_BRA	0100		12-Bit Relative Addressing
 */
char mode1[32] = {	/* S_BRA instructions */
	/* |----|KKKK|KKKK|KKKK| */
	'\200',	'\201',	'\202',	'\203',	'\204',	'\205',	'\206',	'\207',
...
struct	mode	mode[2] = {
    ...
    {	&mode1[0],	0,	0x00000FFF,	0x00000FFF	}
};
...
/*    {	NULL,	".32bit",	S_BITS,		0,	O_4BYTE	},	*/
    ...
    {	NULL,	"add",		S_MATH,		0,	0x00	},
    {	NULL,	"adc",		S_MATH,		0,	0x08	},
    {	NULL,	"sub",		S_MATH,		0,	0x10	},
    {	NULL,	"sbb",		S_MATH,		0,	0x18	},

    {	NULL,	"cmp",		S_CMP,		0,	0x38	},

    {	NULL,	"and",		S_LGC,		0,	0x20	},
    {	NULL,	"or",		S_LGC,		0,	0x28	},
    {	NULL,	"xor",		S_LGC,		0,	0x30	},

    {	NULL,	"asl",		S_SHFT,		0,	0x64	},
    {	NULL,	"asr",		S_SHFT,		0,	0x67	},
    {	NULL,	"rlc",		S_SHFT,		0,	0x6A	},
    {	NULL,	"rrc",		S_SHFT,		0,	0x6D	},

    {	NULL,	"cpl",		S_CPL,		0,	0x73	},

    {	NULL,	"inc",		S_CNT,		0,	0x74	},
    {	NULL,	"dec",		S_CNT,		0,	0x78	},

    {	NULL,	"tst",		S_TST,		0,	0x47	},

    {	NULL,	"swap",		S_SWAP,		0,	0x4B	},

    {	NULL,	"mvi",		S_MVI,		0,	0x3E	},

    {	NULL,	"mov",		S_MOV,		0,	0x50	},

    {	NULL,	"push",		S_PUSH,		0,	0x08	},
    {	NULL,	"pop",		S_PUSH,		0,	0x18	},

    {	NULL,	"ssc",		S_INH,		0,	0x00	},
    {	NULL,	"romx",		S_INH,		0,	0x28	},
    {	NULL,	"halt",		S_INH,		0,	0x30	},
    {	NULL,	"nop",		S_INH,		0,	0x40	},
    {	NULL,	"reti",		S_INH,		0,	0x7E	},
    {	NULL,	"ret",		S_INH,		0,	0x7F	},

    {	NULL,	"lcall",	S_JMP,		0,	0x7C	},
    {	NULL,	"ljmp",		S_JMP,		0,	0x7D	},

    {	NULL,	"jmp",		S_BRA,		0,	0x80	},
    {	NULL,	"call",		S_BRA,		0,	0x90	},
    {	NULL,	"jz",		S_BRA,		0,	0xA0	},
    {	NULL,	"jnz",		S_BRA,		0,	0xB0	},
    {	NULL,	"jc",		S_BRA,		0,	0xC0	},
    {	NULL,	"jnc",		S_BRA,		0,	0xD0	},
    {	NULL,	"jacc",		S_BRA,		0,	0xE0	},
    {	NULL,	"index",	S_BRA,		S_EOL,	0xF0	}
};
