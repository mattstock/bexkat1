...
HEADERS		= ..\..\..\asxxsrc\asxxxx.h C:\SC\INCLUDE\stdlib.h C:\SC\INCLUDE\stdio.h  \
		C:\SC\INCLUDE\setjmp.h C:\SC\INCLUDE\string.h ..\..\..\ASH8\h8.h 
...
OBJS		=  $(OUTPUTDIR)\asdata.OBJ  $(OUTPUTDIR)\asdbg.OBJ  $(OUTPUTDIR)\asexpr.OBJ  \
		 ...
		 $(OUTPUTDIR)\asout.OBJ  $(OUTPUTDIR)\assubr.OBJ  $(OUTPUTDIR)\assym.OBJ  $(OUTPUTDIR)\h8adr.OBJ  \
		 $(OUTPUTDIR)\h8mch.OBJ  $(OUTPUTDIR)\h8pst.OBJ 
...
$(OUTPUTDIR)\h8adr.OBJ:	..\..\..\ASH8\h8adr.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\h8adr.obj ..\..\..\ASH8\h8adr.c



$(OUTPUTDIR)\h8mch.OBJ:	..\..\..\ASH8\h8mch.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\h8mch.obj ..\..\..\ASH8\h8mch.c



$(OUTPUTDIR)\h8pst.OBJ:	..\..\..\ASH8\h8pst.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\h8pst.obj ..\..\..\ASH8\h8pst.c
