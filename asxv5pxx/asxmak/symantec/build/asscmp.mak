...
HEADERS		= ..\..\..\ASXXSRC\asxxxx.h C:\SC\INCLUDE\stdlib.h C:\SC\INCLUDE\stdio.h  \
		C:\SC\INCLUDE\setjmp.h C:\SC\INCLUDE\string.h ..\..\..\ASSCMP\scmp.h 
...
OBJS		=  $(OUTPUTDIR)\asdata.OBJ  $(OUTPUTDIR)\asdbg.OBJ  $(OUTPUTDIR)\asexpr.OBJ  \
		 ...
		 $(OUTPUTDIR)\asout.OBJ  $(OUTPUTDIR)\assubr.OBJ  $(OUTPUTDIR)\assym.OBJ  $(OUTPUTDIR)\scmpadr.OBJ  \
		 $(OUTPUTDIR)\scmpmch.OBJ  $(OUTPUTDIR)\scmppst.OBJ 
...
$(OUTPUTDIR)\scmpadr.OBJ:	..\..\..\ASSCMP\scmpadr.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\scmpadr.obj ..\..\..\ASSCMP\scmpadr.c



$(OUTPUTDIR)\scmpmch.OBJ:	..\..\..\ASSCMP\scmpmch.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\scmpmch.obj ..\..\..\ASSCMP\scmpmch.c



$(OUTPUTDIR)\scmppst.OBJ:	..\..\..\ASSCMP\scmppst.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\scmppst.obj ..\..\..\ASSCMP\scmppst.c
