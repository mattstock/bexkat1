...
HEADERS		= C:\SC\INCLUDE\stdio.h C:\SC\INCLUDE\setjmp.h ..\..\..\asxxsrc\asxxxx.h  \
		..\..\..\AS6816\m6816.h C:\SC\INCLUDE\string.h C:\SC\INCLUDE\alloc.h C:\SC\INCLUDE\stdlib.h 
...
OBJS		=  $(OUTPUTDIR)\asdata.OBJ  $(OUTPUTDIR)\asdbg.OBJ  $(OUTPUTDIR)\asexpr.OBJ  \
		 ...
		 $(OUTPUTDIR)\asout.OBJ  $(OUTPUTDIR)\assubr.OBJ  $(OUTPUTDIR)\assym.OBJ  $(OUTPUTDIR)\m16adr.OBJ  \
		 $(OUTPUTDIR)\m16mch.OBJ  $(OUTPUTDIR)\m16pst.OBJ 
...
$(OUTPUTDIR)\m16adr.OBJ:	..\..\..\AS6816\m16adr.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\m16adr.obj ..\..\..\AS6816\m16adr.c



$(OUTPUTDIR)\m16mch.OBJ:	..\..\..\AS6816\m16mch.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\m16mch.obj ..\..\..\AS6816\m16mch.c



$(OUTPUTDIR)\m16pst.OBJ:	..\..\..\AS6816\m16pst.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\m16pst.obj ..\..\..\AS6816\m16pst.c
