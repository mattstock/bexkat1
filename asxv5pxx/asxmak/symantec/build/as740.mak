...
HEADERS		= ..\..\..\asxxsrc\asxxxx.h C:\SC\INCLUDE\stdlib.h C:\SC\INCLUDE\stdio.h  \
		C:\SC\INCLUDE\setjmp.h C:\SC\INCLUDE\string.h ..\..\..\AS740\m740.h 
...
OBJS		=  $(OUTPUTDIR)\asdata.OBJ  $(OUTPUTDIR)\asdbg.OBJ  $(OUTPUTDIR)\asexpr.OBJ  \
		 ...
		 $(OUTPUTDIR)\asout.OBJ  $(OUTPUTDIR)\assubr.OBJ  $(OUTPUTDIR)\assym.OBJ  $(OUTPUTDIR)\m74adr.OBJ  \
		 $(OUTPUTDIR)\m74mch.OBJ  $(OUTPUTDIR)\m74pst.OBJ 
...
$(OUTPUTDIR)\m74adr.OBJ:	..\..\..\AS740\m74adr.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\m74adr.obj ..\..\..\AS740\m74adr.c



$(OUTPUTDIR)\m74mch.OBJ:	..\..\..\AS740\m74mch.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\m74mch.obj ..\..\..\AS740\m74mch.c



$(OUTPUTDIR)\m74pst.OBJ:	..\..\..\AS740\m74pst.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\m74pst.obj ..\..\..\AS740\m74pst.c
