...
HEADERS		= ..\..\..\ASXXSRC\asxxxx.h C:\SC\INCLUDE\stdlib.h C:\SC\INCLUDE\stdio.h  \
		C:\SC\INCLUDE\setjmp.h C:\SC\INCLUDE\string.h ..\..\..\AS2650\s2650.h 
...
OBJS		=  $(OUTPUTDIR)\asdata.OBJ  $(OUTPUTDIR)\asdbg.OBJ  $(OUTPUTDIR)\asexpr.OBJ  \
		 ...
		 $(OUTPUTDIR)\asout.OBJ  $(OUTPUTDIR)\assubr.OBJ  $(OUTPUTDIR)\assym.OBJ  $(OUTPUTDIR)\s26adr.OBJ  \
		 $(OUTPUTDIR)\s26mch.OBJ  $(OUTPUTDIR)\s26pst.OBJ 
...
$(OUTPUTDIR)\s26adr.OBJ:	..\..\..\AS2650\s26adr.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\s26adr.obj ..\..\..\AS2650\s26adr.c



$(OUTPUTDIR)\s26mch.OBJ:	..\..\..\AS2650\s26mch.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\s26mch.obj ..\..\..\AS2650\s26mch.c



$(OUTPUTDIR)\s26pst.OBJ:	..\..\..\AS2650\s26pst.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\s26pst.obj ..\..\..\AS2650\s26pst.c
