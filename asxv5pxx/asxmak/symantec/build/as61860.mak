...
$(OUTPUTDIR)\s6186mch.OBJ:	..\..\..\AS61860\s6186mch.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\s6186mch.obj ..\..\..\AS61860\s6186mch.c



$(OUTPUTDIR)\s6186pst.OBJ:	..\..\..\AS61860\s6186pst.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\s6186pst.obj ..\..\..\AS61860\s6186pst.c
