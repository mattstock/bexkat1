...
HEADERS		= C:\SC\INCLUDE\stdio.h C:\SC\INCLUDE\setjmp.h ..\..\..\asxxsrc\asxxxx.h  \
		..\..\..\ASEZ80\ez80.h C:\SC\INCLUDE\string.h C:\SC\INCLUDE\alloc.h C:\SC\INCLUDE\stdlib.h 
...
OBJS		=  $(OUTPUTDIR)\asdata.OBJ  $(OUTPUTDIR)\asdbg.OBJ  $(OUTPUTDIR)\asexpr.OBJ  \
		 ...
		 $(OUTPUTDIR)\asout.OBJ  $(OUTPUTDIR)\assubr.OBJ  $(OUTPUTDIR)\assym.OBJ  $(OUTPUTDIR)\ez80adr.OBJ  \
		 $(OUTPUTDIR)\ez80mch.OBJ  $(OUTPUTDIR)\ez80pst.OBJ 
...
$(OUTPUTDIR)\ez80adr.OBJ:	..\..\..\ASEZ80\ez80adr.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\ez80adr.obj ..\..\..\ASEZ80\ez80adr.c



$(OUTPUTDIR)\ez80mch.OBJ:	..\..\..\ASEZ80\ez80mch.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\ez80mch.obj ..\..\..\ASEZ80\ez80mch.c



$(OUTPUTDIR)\ez80pst.OBJ:	..\..\..\ASEZ80\ez80pst.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\ez80pst.obj ..\..\..\ASEZ80\ez80pst.c
