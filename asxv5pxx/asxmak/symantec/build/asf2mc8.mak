...
HEADERS		= ..\..\..\ASF2MC8\f2mc8.h C:\SC\INCLUDE\stdlib.h C:\SC\INCLUDE\stdio.h  \
		C:\SC\INCLUDE\setjmp.h C:\SC\INCLUDE\string.h ..\..\..\\asxxsrc\asxxxx.h ..\..\..\ASXXSRC\asxxxx.h 
...
OBJS		=  $(OUTPUTDIR)\asdata.OBJ  $(OUTPUTDIR)\asdbg.OBJ  $(OUTPUTDIR)\asexpr.OBJ  \
		 ...
		 $(OUTPUTDIR)\asout.OBJ  $(OUTPUTDIR)\assubr.OBJ  $(OUTPUTDIR)\assym.OBJ  $(OUTPUTDIR)\f2mc8adr.OBJ  \
		 $(OUTPUTDIR)\f2mc8mch.OBJ  $(OUTPUTDIR)\f2mc8pst.OBJ 
...
$(OUTPUTDIR)\f2mc8adr.OBJ:	..\..\..\ASF2MC8\f2mc8adr.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\f2mc8adr.obj ..\..\..\ASF2MC8\f2mc8adr.c



$(OUTPUTDIR)\f2mc8mch.OBJ:	..\..\..\ASF2MC8\f2mc8mch.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\f2mc8mch.obj ..\..\..\ASF2MC8\f2mc8mch.c



$(OUTPUTDIR)\f2mc8pst.OBJ:	..\..\..\ASF2MC8\f2mc8pst.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\f2mc8pst.obj ..\..\..\ASF2MC8\f2mc8pst.c
