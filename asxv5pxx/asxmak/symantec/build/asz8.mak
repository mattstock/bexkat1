...
HEADERS		= C:\SC\INCLUDE\stdio.h C:\SC\INCLUDE\setjmp.h C:\SC\INCLUDE\string.h  \
		C:\SC\INCLUDE\alloc.h C:\SC\INCLUDE\stdlib.h ..\..\..\ASXXSRC\asxxxx.h ..\..\..\ASZ8\z8.h 
...
OBJS		=  $(OUTPUTDIR)\asdata.OBJ  $(OUTPUTDIR)\asdbg.OBJ  $(OUTPUTDIR)\asexpr.OBJ  \
		 ...
		 $(OUTPUTDIR)\asout.OBJ  $(OUTPUTDIR)\assubr.OBJ  $(OUTPUTDIR)\assym.OBJ  $(OUTPUTDIR)\z8adr.OBJ  \
		 $(OUTPUTDIR)\z8mch.OBJ  $(OUTPUTDIR)\z8pst.OBJ 
...
$(OUTPUTDIR)\z8adr.OBJ:	..\..\..\ASZ8\z8adr.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\z8adr.obj ..\..\..\ASZ8\z8adr.c



$(OUTPUTDIR)\z8mch.OBJ:	..\..\..\ASZ8\z8mch.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\z8mch.obj ..\..\..\ASZ8\z8mch.c



$(OUTPUTDIR)\z8pst.OBJ:	..\..\..\ASZ8\z8pst.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\z8pst.obj ..\..\..\ASZ8\z8pst.c
