...
INCLUDES	= -I..\..\..\aspic\ptoa

INCLUDEDOBJS	= 

OBJS		=  $(OUTPUTDIR)\pictoasx.OBJ  $(OUTPUTDIR)\PtoA.OBJ 
...
!IF EXIST (pictoasx.dpd)
!INCLUDE pictoasx.dpd
!ENDIF



$(OUTPUTDIR)\pictoasx.OBJ:	..\..\..\ASPIC\PTOA\pictoasx.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\pictoasx.obj ..\..\..\ASPIC\PTOA\pictoasx.c
