...
HEADERS		= C:\SC\INCLUDE\stdio.h C:\SC\INCLUDE\setjmp.h ..\..\..\asxxsrc\asxxxx.h  \
		..\..\..\AS6805\m6805.h C:\SC\INCLUDE\string.h C:\SC\INCLUDE\alloc.h C:\SC\INCLUDE\stdlib.h 
...
OBJS		=  $(OUTPUTDIR)\asdata.OBJ  $(OUTPUTDIR)\asdbg.OBJ  $(OUTPUTDIR)\asexpr.OBJ  \
		 ...
		 $(OUTPUTDIR)\asout.OBJ  $(OUTPUTDIR)\assubr.OBJ  $(OUTPUTDIR)\assym.OBJ  $(OUTPUTDIR)\m05adr.OBJ  \
		 $(OUTPUTDIR)\m05mch.OBJ  $(OUTPUTDIR)\m05pst.OBJ 
...
$(OUTPUTDIR)\m05adr.OBJ:	..\..\..\AS6805\m05adr.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\m05adr.obj ..\..\..\AS6805\m05adr.c



$(OUTPUTDIR)\m05mch.OBJ:	..\..\..\AS6805\m05mch.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\m05mch.obj ..\..\..\AS6805\m05mch.c



$(OUTPUTDIR)\m05pst.OBJ:	..\..\..\AS6805\m05pst.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\m05pst.obj ..\..\..\AS6805\m05pst.c
