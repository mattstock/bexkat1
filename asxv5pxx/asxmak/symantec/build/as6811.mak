...
HEADERS		= ..\..\..\asxxsrc\asxxxx.h C:\SC\INCLUDE\stdlib.h C:\SC\INCLUDE\stdio.h  \
		C:\SC\INCLUDE\setjmp.h C:\SC\INCLUDE\string.h ..\..\..\AS6811\m6811.h 
...
OBJS		=  $(OUTPUTDIR)\asdata.OBJ  $(OUTPUTDIR)\asdbg.OBJ  $(OUTPUTDIR)\asexpr.OBJ  \
		 ...
		 $(OUTPUTDIR)\asout.OBJ  $(OUTPUTDIR)\assubr.OBJ  $(OUTPUTDIR)\assym.OBJ  $(OUTPUTDIR)\m11adr.OBJ  \
		 $(OUTPUTDIR)\m11mch.OBJ  $(OUTPUTDIR)\m11pst.OBJ 
...
$(OUTPUTDIR)\m11adr.OBJ:	..\..\..\AS6811\m11adr.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\m11adr.obj ..\..\..\AS6811\m11adr.c



$(OUTPUTDIR)\m11mch.OBJ:	..\..\..\AS6811\m11mch.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\m11mch.obj ..\..\..\AS6811\m11mch.c



$(OUTPUTDIR)\m11pst.OBJ:	..\..\..\AS6811\m11pst.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\m11pst.obj ..\..\..\AS6811\m11pst.c
