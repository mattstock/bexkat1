...
HEADERS		= ..\..\..\ASXXSRC\asxxxx.h C:\SC\INCLUDE\stdlib.h C:\SC\INCLUDE\stdio.h  \
		C:\SC\INCLUDE\setjmp.h C:\SC\INCLUDE\string.h ..\..\..\AS8048\i8048.h 
...
OBJS		=  $(OUTPUTDIR)\asdata.OBJ  $(OUTPUTDIR)\asdbg.OBJ  $(OUTPUTDIR)\asexpr.OBJ  \
		 ...
		 $(OUTPUTDIR)\asout.OBJ  $(OUTPUTDIR)\assubr.OBJ  $(OUTPUTDIR)\assym.OBJ  $(OUTPUTDIR)\i48adr.OBJ  \
		 $(OUTPUTDIR)\i48mch.OBJ  $(OUTPUTDIR)\i48pst.OBJ 
...
$(OUTPUTDIR)\i48adr.OBJ:	..\..\..\AS8048\i48adr.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\i48adr.obj ..\..\..\AS8048\i48adr.c



$(OUTPUTDIR)\i48mch.OBJ:	..\..\..\AS8048\i48mch.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\i48mch.obj ..\..\..\AS8048\i48mch.c



$(OUTPUTDIR)\i48pst.OBJ:	..\..\..\AS8048\i48pst.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\i48pst.obj ..\..\..\AS8048\i48pst.c
