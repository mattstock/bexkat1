...
HEADERS		= ..\..\..\asxxsrc\asxxxx.h C:\SC\INCLUDE\stdlib.h C:\SC\INCLUDE\stdio.h  \
		C:\SC\INCLUDE\setjmp.h C:\SC\INCLUDE\string.h ..\..\..\ASRAB\rab.h 
...
OBJS		=  $(OUTPUTDIR)\asdata.OBJ  $(OUTPUTDIR)\asdbg.OBJ  $(OUTPUTDIR)\asexpr.OBJ  \
		 ...
		 $(OUTPUTDIR)\asout.OBJ  $(OUTPUTDIR)\assubr.OBJ  $(OUTPUTDIR)\assym.OBJ  $(OUTPUTDIR)\rabadr.OBJ  \
		 $(OUTPUTDIR)\rabmch.OBJ  $(OUTPUTDIR)\rabpst.OBJ 
...
$(OUTPUTDIR)\rabadr.OBJ:	..\..\..\ASRAB\rabadr.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\rabadr.obj ..\..\..\ASRAB\rabadr.c



$(OUTPUTDIR)\rabmch.OBJ:	..\..\..\ASRAB\rabmch.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\rabmch.obj ..\..\..\ASRAB\rabmch.c



$(OUTPUTDIR)\rabpst.OBJ:	..\..\..\ASRAB\rabpst.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\rabpst.obj ..\..\..\ASRAB\rabpst.c
