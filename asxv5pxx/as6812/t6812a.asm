	.title	AS6812 Test Code T6812a.asm
...
;noofst	movb	5,-y,0,pc	;18 0a 6b c0
	...
	bset	ext,#0x55	;1c 12 34 55
 	...
 	movw	ext,  2,x 	;18 01 02 12 34
 	movw	2,x,  0,x	;18 02 02 00

	movb	1,sp,ext	;18 0d 81 12 34
	movb	1,sp,12,x	;18 0a 81 0c
	movw	2,sp,ext	;18 05 82 12 34
	movw	2,sp,12,x	;18 02 82 0c

	
	movb  	#immed,1,-sp	;18 08 af 72
	movw	ext,2,-sp	;18 01 ae 12 34
	movb	ext,1,-sp	;18 09 af 12 34
	movw	#immed,2,-sp	;18 00 ae 00 72
...
a:	aba			;18 06
	...
	ext	=	ROT001
	adca	ext,x		;a9 e2 89 44
	ext	=	ROT002
	adca	ext,x		;a9 e2 33 33
	ext	=	ROT003
	adca	ext,x		;a9 e2 44 44
	ext	=	ROT000
	adca	ext,x		;a9 e2 01 88
	adca	1,y+		;a9 70
	adca	1,sp		;a9 81
...
c:	cba			;18 17
	...
	com	*dir		;71 00 57
	com	ext		;71 01 88
	com	ext,sp		;61 f2 01 88
	com	ext,x		;61 e2 01 88
	com	ext,y		;61 ea 01 88
	com	ind,pc		;61 f8 37
	com	ind,sp		;61 f0 37
	com	ind,x		;61 e0 37
	com	ind,y		;61 e8 37
...
d:	daa			;18 07
	...
	dec	*dir		;73 00 57
	dec	ext		;73 01 88
	dec	ext,sp		;63 f2 01 88
	dec	ext,x		;63 e2 01 88
	dec	ext,y		;63 ea 01 88
	dec	ind,pc		;63 f8 37
	dec	ind,sp		;63 f0 37
	dec	ind,x		;63 e0 37
	dec	ind,y		;63 e8 37
...
e:	ediv			;11
	edivs			;18 14
	emacs	*dir		;18 12 00 57
	emacs	ext		;18 12 01 88
	...
	emaxd	d,x		;18 1a e6
	emaxd	d,y		;18 1a ee
	emaxd	ext,sp		;18 1a f2 01 88
	emaxd	ext,x		;18 1a e2 01 88
	emaxd	ext,y		;18 1a ea 01 88
	...
	emaxm	d,x		;18 1e e6
	emaxm	d,y		;18 1e ee
	emaxm	ext,sp		;18 1e f2 01 88
	emaxm	ext,x		;18 1e e2 01 88
	emaxm	ext,y		;18 1e ea 01 88
	...
	emind	d,x		;18 1b e6
	emind	d,y		;18 1b ee
	emind	ext,sp		;18 1b f2 01 88
	emind	ext,x		;18 1b e2 01 88
	emind	ext,y		;18 1b ea 01 88
	...
	eminm	d,x		;18 1f e6
	eminm	d,y		;18 1f ee
	eminm	ext,sp		;18 1f f2 01 88
	eminm	ext,x		;18 1f e2 01 88
	eminm	ext,y		;18 1f ea 01 88
...
i:	idiv			;18 10
	...
	inc	*dir		;72 00 57
	inc	ext		;72 01 88
	inc	ext,sp		;62 f2 01 88
	inc	ext,x		;62 e2 01 88
	inc	ext,y		;62 ea 01 88
	inc	ind,pc		;62 f8 37
	inc	ind,sp		;62 f0 37
	inc	ind,x		;62 e0 37
	inc	ind,y		;62 e8 37
...
j:	jmp	1,+sp		;05 a0
	...
	jmp	*dir		;06 00 57
	jmp	ext		;06 01 88
	jmp	ext,sp		;05 f2 01 88
	jmp	ext,x		;05 e2 01 88
	jmp	ext,y		;05 ea 01 88
	jmp	ind,pc		;05 f8 37
	jmp	ind,sp		;05 f0 37
	jmp	ind,x		;05 e0 37
	jmp	ind,y		;05 e8 37
...
l:	lbcc	.		;18 24 ff fc
	...
	leas	d,x		;1b e6
	leas	d,y		;1b ee
	leas	ext,sp		;1b f2 01 88
	leas	ext,x		;1b e2 01 88
	leas	ext,y		;1b ea 01 88
	...
	leax	d,x		;1a e6
	leax	d,y		;1a ee
	leax	ext,sp		;1a f2 01 88
	leax	ext,x		;1a e2 01 88
	leax	ext,y		;1a ea 01 88
	...
	leay	d,x		;19 e6
	leay	d,y		;19 ee
	leay	ext,sp		;19 f2 01 88
	leay	ext,x		;19 e2 01 88
	leay	ext,y		;19 ea 01 88
	...
	lsl	*dir		;78 00 57
	lsl	ext		;78 01 88
	lsl	ext,sp		;68 f2 01 88
	lsl	ext,x		;68 e2 01 88
	lsl	ext,y		;68 ea 01 88
	lsl	ind,pc		;68 f8 37
	lsl	ind,sp		;68 f0 37
	lsl	ind,x		;68 e0 37
	lsl	ind,y		;68 e8 37
	...
	lsr	*dir		;74 00 57
	lsr	ext		;74 01 88
	lsr	ext,sp		;64 f2 01 88
	lsr	ext,x		;64 e2 01 88
	lsr	ext,y		;64 ea 01 88
	lsr	ind,pc		;64 f8 37
	lsr	ind,sp		;64 f0 37
	lsr	ind,x		;64 e0 37
	lsr	ind,y		;64 e8 37
...
m:	maxa	1,+sp		;18 18 a0
	...
	maxa	d,x		;18 18 e6
	maxa	d,y		;18 18 ee
	maxa	ext,sp		;18 18 f2 01 88
	maxa	ext,x		;18 18 e2 01 88
	maxa	ext,y		;18 18 ea 01 88
	...
	maxm	d,x		;18 1c e6
	maxm	d,y		;18 1c ee
	maxm	ext,sp		;18 1c f2 01 88
	maxm	ext,x		;18 1c e2 01 88
	maxm	ext,y		;18 1c ea 01 88
	...
	mina	d,x		;18 19 e6
	mina	d,y		;18 19 ee
	mina	ext,sp		;18 19 f2 01 88
	mina	ext,x		;18 19 e2 01 88
	mina	ext,y		;18 19 ea 01 88
	...
	minm	d,x		;18 1d e6
	minm	d,y		;18 1d ee
	minm	ext,sp		;18 1d f2 01 88
	minm	ext,x		;18 1d e2 01 88
	minm	ext,y		;18 1d ea 01 88
...
n:	neg	1,+sp		;60 a0
	...
	neg	*dir		;70 00 57
	neg	ext		;70 01 88
	neg	ext,sp		;60 f2 01 88
	neg	ext,x		;60 e2 01 88
	neg	ext,y		;60 ea 01 88
	neg	ind,pc		;60 f8 37
	neg	ind,sp		;60 f0 37
	neg	ind,x		;60 e0 37
	neg	ind,y		;60 e8 37
...
r:	rev			;18 3a
	...
	rol	*dir		;75 00 57
	rol	ext		;75 01 88
	rol	ext,sp		;65 f2 01 88
	rol	ext,x		;65 e2 01 88
	rol	ext,y		;65 ea 01 88
	rol	ind,pc		;65 f8 37
	rol	ind,sp		;65 f0 37
	rol	ind,x		;65 e0 37
	rol	ind,y		;65 e8 37
	...
	ror	*dir		;76 00 57
	ror	ext		;76 01 88
	ror	ext,sp		;66 f2 01 88
	ror	ext,x		;66 e2 01 88
	ror	ext,y		;66 ea 01 88
	ror	ind,pc		;66 f8 37
	ror	ind,sp		;66 f0 37
	ror	ind,x		;66 e0 37
	ror	ind,y		;66 e8 37
...
t:	tab			;18 0e
	...
	tst	*dir		;f7 00 57
	tst	ext		;f7 01 88
	tst	ext,sp		;e7 f2 01 88
	tst	ext,x		;e7 e2 01 88
	tst	ext,y		;e7 ea 01 88
	tst	ind,pc		;e7 f8 37
	tst	ind,sp		;e7 f0 37
	tst	ind,x		;e7 e0 37
	tst	ind,y		;e7 e8 37
...
call:	call	1,+sp,pg 	;4b a0 36
	call	1,+x,pg		;4b 20 36
	call	1,+y,pg		;4b 60 36
	call	8,+sp,pg	;4b a7 36
	call	8,+x,pg		;4b 27 36
	call	8,+y,pg		;4b 67 36
	call	,pc,pg		;4b c0 36
	call	,sp,pg		;4b 80 36
	call	,x,pg		;4b 00 36
	call	,y,pg		;4b 40 36
	call	1,-sp,pg	;4b af 36
	call	1,-x,pg		;4b 2f 36
	call	1,-y,pg		;4b 6f 36
	call	8,-sp,pg	;4b a8 36
	call	8,-x,pg		;4b 28 36
	call	8,-y,pg		;4b 68 36
	call	-1,sp,pg	;4b 9f 36
	call	-1,x,pg		;4b 1f 36
	call	-1,y,pg		;4b 5f 36
	call	-16,sp,pg	;4b 90 36
	call	-16,x,pg	;4b 10 36
	call	-16,y,pg	;4b 50 36
	call	-17,sp,pg	;4b f1 ef 36
	call	-17,x,pg	;4b e1 ef 36
	call	-17,y,pg	;4b e9 ef 36
	call	-small,pc,pg	;4b d2 36
	call	-small,sp,pg	;4b 92 36
	call	-small,x,pg	;4b 12 36
	call	-small,y,pg	;4b 52 36
	call	0,pc,pg		;4b c0 36
	call	0,sp,pg		;4b 80 36
	call	0,x,pg		;4b 00 36
	call	0,y,pg		;4b 40 36
	call	1,sp+,pg	;4b b0 36
	call	1,x+,pg		;4b 30 36
	call	1,y+,pg		;4b 70 36
	call	1,sp,pg		;4b 81 36
	call	1,x,pg		;4b 01 36
	call	1,y,pg		;4b 41 36
	call	1,sp-,pg	;4b bf 36
	call	1,x-,pg		;4b 3f 36
	call	1,y-,pg		;4b 7f 36
	call	125,pc,pg	;4b f8 7d 36
	call	125,sp,pg	;4b f0 7d 36
	call	125,x,pg	;4b e0 7d 36
	call	125,y,pg	;4b e8 7d 36
	call	15,sp,pg	;4b 8f 36
	call	15,x,pg		;4b 0f 36
	call	15,y,pg		;4b 4f 36
	call	16,sp,pg	;4b f0 10 36
	call	16,x,pg		;4b e0 10 36
	call	16,y,pg		;4b e8 10 36
	call	8,sp+,pg	;4b b7 36
	call	8,x+,pg		;4b 37 36
	call	8,y+,pg		;4b 77 36
	call	8,sp-,pg	;4b b8 36
	call	8,x-,pg		;4b 38 36
	call	8,y-,pg		;4b 78 36
	call	a,sp,pg		;4b f4 36
	call	a,x,pg		;4b e4 36
	call	a,y,pg		;4b ec 36
	call	b,sp,pg		;4b f5 36
	call	b,x,pg		;4b e5 36
	call	b,y,pg		;4b ed 36
	call	d,sp,pg		;4b f6 36
	call	d,x,pg		;4b e6 36
	call	d,y,pg		;4b ee 36
	call	*dir,pg		;4a 00 57 36
	call	ext,pg		;4a 01 88 36
	call	ext,sp,pg	;4b f2 01 88 36
	call	ext,x,pg	;4b e2 01 88 36
	call	ext,y,pg	;4b ea 01 88 36
	call	ind,pc,pg	;4b f8 37 36
	call	ind,sp,pg	;4b f0 37 36
	call	ind,x,pg	;4b e0 37 36
	call	ind,y,pg	;4b e8 37 36
	call	small,pc,pg	;4b ce 36
	call	small,sp,pg	;4b 8e 36
	call	small,x,pg	;4b 0e 36
	call	small,y,pg	;4b 4e 36

movb:	movb	#immed,3,+x	;18 08 22 72
	movb	#immed,5,-y	;18 08 6b 72
	movb	#immed,5,sp	;18 08 85 72
	movb	#immed,ext	;18 0b 72 01 88
	movb	1,+sp,3,+x	;18 0a a0 22
	movb	1,+sp,5,-y	;18 0a a0 6b
	movb	1,+sp,5,sp	;18 0a a0 85
	movb	1,+sp,ext	;18 0d a0 01 88
	movb	1,+x,3,+x 	;18 0a 20 22
	movb	1,+x,5,-y	;18 0a 20 6b
	movb	1,+x,5,sp	;18 0a 20 85
	movb	1,+x,ext 	;18 0d 20 01 88
	movb	1,+y,3,+x	;18 0a 60 22
	movb	1,+y,5,-y	;18 0a 60 6b
	movb	1,+y,5,sp	;18 0a 60 85
	movb	1,+y,ext	;18 0d 60 01 88
...
;noofst	movb	5,sp,small,pc 	;18 0a 85 ce
	...
	movb	8,sp+,ext	;18 0d b7 01 88
	movb	8,x+,3,+x	;18 0a 37 22
	movb	8,x+,5,-y	;18 0a 37 6b
	movb	8,x+,5,sp	;18 0a 37 85
	movb	8,x+,ext	;18 0d 37 01 88
	movb	8,y+,3,+x	;18 0a 77 22
	movb	8,y+,5,-y	;18 0a 77 6b
	movb	8,y+,5,sp	;18 0a 77 85
	movb	8,y+,ext	;18 0d 77 01 88
	movb	8,sp-,3,+x	;18 0a b8 22
	movb	8,sp-,5,-y	;18 0a b8 6b
	movb	8,sp-,5,sp	;18 0a b8 85
	movb	8,sp-,ext	;18 0d b8 01 88
	movb	8,x-,3,+x	;18 0a 38 22
	movb	8,x-,5,-y	;18 0a 38 6b
	movb	8,x-,5,sp	;18 0a 38 85
	movb	8,x-,ext	;18 0d 38 01 88
	movb	8,y-,3,+x	;18 0a 78 22
	movb	8,y-,5,-y	;18 0a 78 6b
	movb	8,y-,5,sp	;18 0a 78 85
	movb	8,y-,ext	;18 0d 78 01 88
	movb	a,sp,3,+x	;18 0a f4 22
	movb	a,sp,5,-y	;18 0a f4 6b
	movb	a,sp,5,sp	;18 0a f4 85
	movb	a,sp,ext	;18 0d f4 01 88
	movb	a,x,3,+x	;18 0a e4 22
	movb	a,x,5,-y	;18 0a e4 6b
	movb	a,x,5,sp	;18 0a e4 85
	movb	a,x,ext		;18 0d e4 01 88
	movb	a,y,3,+x	;18 0a ec 22
	movb	a,y,5,-y	;18 0a ec 6b
	movb	a,y,5,sp	;18 0a ec 85
	movb	a,y,ext		;18 0d ec 01 88
	movb	b,sp,3,+x	;18 0a f5 22
	movb	b,sp,5,-y	;18 0a f5 6b
	movb	b,sp,5,sp	;18 0a f5 85
	movb	b,sp,ext	;18 0d f5 01 88
	movb	b,x,3,+x	;18 0a e5 22
	movb	b,x,5,-y	;18 0a e5 6b
	movb	b,x,5,sp	;18 0a e5 85
	movb	b,x,ext		;18 0d e5 01 88
	movb	b,y,3,+x	;18 0a ed 22
	movb	b,y,5,-y	;18 0a ed 6b
	movb	b,y,5,sp	;18 0a ed 85
	movb	b,y,ext 	;18 0d ed 01 88
	movb	d,sp,3,+x	;18 0a f6 22
	movb	d,sp,5,-y	;18 0a f6 6b
	movb	d,sp,5,sp	;18 0a f6 85
	movb	d,sp,ext	;18 0d f6 01 88
	movb	d,x,3,+x	;18 0a e6 22
	movb	d,x,5,-y	;18 0a e6 6b
	movb	d,x,5,sp	;18 0a e6 85
	movb	d,x,ext		;18 0d e6 01 88
	movb	d,y,3,+x	;18 0a ee 22
	movb	d,y,5,-y	;18 0a ee 6b
	movb	d,y,5,sp	;18 0a ee 85
	movb	d,y,ext		;18 0d ee 01 88
	movb	ext,1,+sp 	;18 09 a0 01 88
	movb	ext,1,+x 	;18 09 20 01 88
	movb	ext,1,+y 	;18 09 60 01 88
	movb	ext,8,+sp 	;18 09 a7 01 88
	movb	ext,8,+x 	;18 09 27 01 88
	movb	ext,8,+y 	;18 09 67 01 88
;noofst	movb	ext,0,pc 	;18 09 c0 01 88
	movb	ext,0,pc 	;18 09 de 01 88
	movb	ext,0,sp 	;18 09 80 01 88
	movb	ext,0,x   	;18 09 00 01 88
	movb	ext,0,y 	;18 09 40 01 88
	movb	ext,1,-sp	;18 09 af 01 88
	movb	ext,1,-x	;18 09 2f 01 88
	movb	ext,1,-y 	;18 09 6f 01 88
	movb	ext,8,-sp 	;18 09 a8 01 88
	movb	ext,8,-x 	;18 09 28 01 88
	movb	ext,8,-y  	;18 09 68 01 88
	movb	ext,-1,sp 	;18 09 9f 01 88
	movb	ext,-1,x 	;18 09 1f 01 88
	movb	ext,-1,y 	;18 09 5f 01 88
	movb	ext,-16,sp 	;18 09 90 01 88
	movb	ext,-16,x 	;18 09 10 01 88
	movb	ext,-16,y 	;18 09 50 01 88
;noofst	movb	ext,-small,pc 	;18 09 d2 01 88
	movb	ext,-small,pc 	;18 09 d0 01 88
	movb	ext,-small,sp 	;18 09 92 01 88
	movb	ext,-small,x 	;18 09 12 01 88
	movb	ext,-small,y 	;18 09 52 01 88
;noofst	movb	ext,0,pc 	;18 09 c0 01 88
	movb	ext,0,pc 	;18 09 de 01 88
	movb	ext,0,sp 	;18 09 80 01 88
	movb	ext,0,x 	;18 09 00 01 88
	movb	ext,0,y 	;18 09 40 01 88
	movb	ext,1,sp+ 	;18 09 b0 01 88
	movb	ext,1,x+ 	;18 09 30 01 88
	movb	ext,1,y+ 	;18 09 70 01 88
	movb	ext,1,sp 	;18 09 81 01 88
	movb	ext,1,x 	;18 09 01 01 88
	movb	ext,1,y 	;18 09 41 01 88
	movb	ext,1,sp- 	;18 09 bf 01 88
	movb	ext,1,x- 	;18 09 3f 01 88
	movb	ext,1,y- 	;18 09 7f 01 88
	movb	ext,8,sp+ 	;18 09 b7 01 88
	movb	ext,8,x+ 	;18 09 37 01 88
	movb	ext,8,y+ 	;18 09 77 01 88
	movb	ext,8,sp- 	;18 09 b8 01 88
	movb	ext,8,x- 	;18 09 38 01 88
	movb	ext,8,y- 	;18 09 78 01 88
	movb	ext,a,sp 	;18 09 f4 01 88
	movb	ext,a,x 	;18 09 e4 01 88
	movb	ext,a,y		;18 09 ec 01 88
	movb	ext,b,sp 	;18 09 f5 01 88
	movb	ext,b,x 	;18 09 e5 01 88
	movb	ext,b,y 	;18 09 ed 01 88
	movb	ext,d,sp 	;18 09 f6 01 88
	movb	ext,d,x 	;18 09 e6 01 88
	movb	ext,d,y 	;18 09 ee 01 88
	movb	ext,ext 	;18 0c 01 88 01 88
;noofst	movb	ext,small,pc	;18 09 ce 01 88
	movb	ext,small,pc	;18 09 cc 01 88
	movb	ext,small,sp 	;18 09 8e 01 88
	movb	ext,small,x 	;18 09 0e 01 88
	movb	ext,small,y 	;18 09 4e 01 88
...
;noofst	movw	5,sp,small,pc 	;18 02 85 ce
	...
	movw	8,sp+,ext	;18 05 b7 01 88
	movw	8,x+,3,+x	;18 02 37 22
	movw	8,x+,5,-y	;18 02 37 6b
	movw	8,x+,5,sp	;18 02 37 85
	movw	8,x+,ext	;18 05 37 01 88
	movw	8,y+,3,+x	;18 02 77 22
	movw	8,y+,5,-y	;18 02 77 6b
	movw	8,y+,5,sp	;18 02 77 85
	movw	8,y+,ext	;18 05 77 01 88
	movw	8,sp-,3,+x	;18 02 b8 22
	movw	8,sp-,5,-y	;18 02 b8 6b
	movw	8,sp-,5,sp	;18 02 b8 85
	movw	8,sp-,ext	;18 05 b8 01 88
	movw	8,x-,3,+x	;18 02 38 22
	movw	8,x-,5,-y	;18 02 38 6b
	movw	8,x-,5,sp	;18 02 38 85
	movw	8,x-,ext	;18 05 38 01 88
	movw	8,y-,3,+x	;18 02 78 22
	movw	8,y-,5,-y	;18 02 78 6b
	movw	8,y-,5,sp	;18 02 78 85
	movw	8,y-,ext	;18 05 78 01 88
	movw	a,sp,3,+x	;18 02 f4 22
	movw	a,sp,5,-y	;18 02 f4 6b
	movw	a,sp,5,sp	;18 02 f4 85
	movw	a,sp,ext	;18 05 f4 01 88
	movw	a,x,3,+x	;18 02 e4 22
	movw	a,x,5,-y	;18 02 e4 6b
	movw	a,x,5,sp	;18 02 e4 85
	movw	a,x,ext		;18 05 e4 01 88
	movw	a,y,3,+x	;18 02 ec 22
	movw	a,y,5,-y	;18 02 ec 6b
	movw	a,y,5,sp	;18 02 ec 85
	movw	a,y,ext		;18 05 ec 01 88
	movw	b,sp,3,+x	;18 02 f5 22
	movw	b,sp,5,-y	;18 02 f5 6b
	movw	b,sp,5,sp	;18 02 f5 85
	movw	b,sp,ext	;18 05 f5 01 88
	movw	b,x,3,+x	;18 02 e5 22
	movw	b,x,5,-y	;18 02 e5 6b
	movw	b,x,5,sp	;18 02 e5 85
	movw	b,x,ext		;18 05 e5 01 88
	movw	b,y,3,+x	;18 02 ed 22
	movw	b,y,5,-y	;18 02 ed 6b
	movw	b,y,5,sp	;18 02 ed 85
	movw	b,y,ext		;18 05 ed 01 88
	movw	d,sp,3,+x	;18 02 f6 22
	movw	d,sp,5,-y	;18 02 f6 6b
	movw	d,sp,5,sp	;18 02 f6 85
	movw	d,sp,ext	;18 05 f6 01 88
	movw	d,x,3,+x	;18 02 e6 22
	movw	d,x,5,-y	;18 02 e6 6b
	movw	d,x,5,sp	;18 02 e6 85
	movw	d,x,ext		;18 05 e6 01 88
	movw	d,y,3,+x	;18 02 ee 22
	movw	d,y,5,-y	;18 02 ee 6b
	movw	d,y,5,sp	;18 02 ee 85
	movw	d,y,ext 	;18 05 ee 01 88
	movw	ext,1,+sp 	;18 01 a0 01 88
	movw	ext,1,+x 	;18 01 20 01 88
	movw	ext,1,+y 	;18 01 60 01 88
	movw	ext,8,+sp 	;18 01 a7 01 88
	movw	ext,8,+x 	;18 01 27 01 88
	movw	ext,8,+y 	;18 01 67 01 88
;noofst	movw	ext,0,pc 	;18 01 c0 01 88
	movw	ext,0,pc 	;18 01 de 01 88
	movw	ext,0,sp 	;18 01 80 01 88
	movw	ext,0,x 	;18 01 00 01 88
	movw	ext,0,y 	;18 01 40 01 88
	movw	ext,1,-sp 	;18 01 af 01 88
	movw	ext,1,-x 	;18 01 2f 01 88
	movw	ext,1,-y 	;18 01 6f 01 88
	movw	ext,8,-sp 	;18 01 a8 01 88
	movw	ext,8,-x 	;18 01 28 01 88
	movw	ext,8,-y 	;18 01 68 01 88
	movw	ext,-1,sp 	;18 01 9f 01 88
	movw	ext,-1,x 	;18 01 1f 01 88
	movw	ext,-1,y 	;18 01 5f 01 88
	movw	ext,-16,sp 	;18 01 90 01 88
	movw	ext,-16,x 	;18 01 10 01 88
	movw	ext,-16,y 	;18 01 50 01 88
;noofst	movw	ext,-small,pc 	;18 01 d2 01 88
	movw	ext,-small,pc 	;18 01 d0 01 88
	movw	ext,-small,sp 	;18 01 92 01 88
	movw	ext,-small,x 	;18 01 12 01 88
	movw	ext,-small,y 	;18 01 52 01 88
;noofst	movw	ext,0,pc 	;18 01 c0 01 88
	movw	ext,0,pc 	;18 01 de 01 88
	movw	ext,0,sp 	;18 01 80 01 88
	movw	ext,0,x 	;18 01 00 01 88
	movw	ext,0,y 	;18 01 40 01 88
	movw	ext,1,sp+ 	;18 01 b0 01 88
	movw	ext,1,x+ 	;18 01 30 01 88
	movw	ext,1,y+ 	;18 01 70 01 88
	movw	ext,1,sp 	;18 01 81 01 88
	movw	ext,1,x 	;18 01 01 01 88
	movw	ext,1,y 	;18 01 41 01 88
	movw	ext,1,sp- 	;18 01 bf 01 88
	movw	ext,1,x- 	;18 01 3f 01 88
	movw	ext,1,y- 	;18 01 7f 01 88
	movw	ext,8,sp+ 	;18 01 b7 01 88
	movw	ext,8,x+ 	;18 01 37 01 88
	movw	ext,8,y+ 	;18 01 77 01 88
	movw	ext,8,sp- 	;18 01 b8 01 88
	movw	ext,8,x- 	;18 01 38 01 88
	movw	ext,8,y- 	;18 01 78 01 88
	movw	ext,a,sp 	;18 01 f4 01 88
	movw	ext,a,x 	;18 01 e4 01 88
	movw	ext,a,y 	;18 01 ec 01 88
	movw	ext,b,sp 	;18 01 f5 01 88
	movw	ext,b,x 	;18 01 e5 01 88
	movw	ext,b,y 	;18 01 ed 01 88
	movw	ext,d,sp 	;18 01 f6 01 88
	movw	ext,d,x 	;18 01 e6 01 88
	movw	ext,d,y 	;18 01 ee 01 88
	movw	ext,ext		;18 04 01 88 01 88
;noofst	movw	ext,small,pc 	;18 01 ce 01 88
	movw	ext,small,pc 	;18 01 cc 01 88
	movw	ext,small,sp 	;18 01 8e 01 88
	movw	ext,small,x 	;18 01 0e 01 88
	movw	ext,small,y 	;18 01 4e 01 88
