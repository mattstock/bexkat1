...
/*    {	NULL,	".32bit",	S_BITS,		0,	O_4BYTE	},	*/
    ...
    {	NULL,	"ld",		S_MRI,		0,	0xC0	},
    {	NULL,	"st",		S_MRI,		0,	0xC8	},
    {	NULL,	"and",		S_MRI,		0,	0xD0	},
    {	NULL,	"or",		S_MRI,		0,	0xD8	},
    {	NULL,	"xor",		S_MRI,		0,	0xE0	},
    {	NULL,	"dad",		S_MRI,		0,	0xE8	},
    {	NULL,	"add",		S_MRI,		0,	0xF0	},
    {	NULL,	"cad",		S_MRI,		0,	0xF8	},

    {	NULL,	"ldi",		S_II,		0,	0xC4	},
    {	NULL,	"ani",		S_II,		0,	0xD4	},
    {	NULL,	"ori",		S_II,		0,	0xDC	},
    {	NULL,	"xri",		S_II,		0,	0xE4	},
    {	NULL,	"dai",		S_II,		0,	0xEC	},
    {	NULL,	"adi",		S_II,		0,	0xF4	},
    {	NULL,	"cai",		S_II,		0,	0xFC	},

    {	NULL,	"ild",		S_MID,		0,	0xA8	},
    {	NULL,	"dld",		S_MID,		0,	0xB8	},

    {	NULL,	"dly",		S_DLY,		0,	0x8F	},

    {	NULL,	"jmp",		S_JMP,		0,	0x90	},
    {	NULL,	"jp",		S_JMP,		0,	0x94	},
    {	NULL,	"jz",		S_JMP,		0,	0x98	},
    {	NULL,	"jnz",		S_JMP,		0,	0x9C	},

    {	NULL,	"xpal",		S_XP,		0,	0x30	},
    {	NULL,	"xpah",		S_XP,		0,	0x34	},
    {	NULL,	"xppc",		S_XP,		0,	0x3C	},

    {	NULL,	"halt",		S_INH,		0,	0x00	},
    {	NULL,	"ccl",		S_INH,		0,	0x02	},
    {	NULL,	"scl",		S_INH,		0,	0x03	},
    {	NULL,	"dint",		S_INH,		0,	0x04	},
    {	NULL,	"ien",		S_INH,		0,	0x05	},
    {	NULL,	"csa",		S_INH,		0,	0x06	},
    {	NULL,	"cas",		S_INH,		0,	0x07	},
    {	NULL,	"nop",		S_INH,		0,	0x08	},

    {	NULL,	"sio",		S_INH,		0,	0x19	},
    {	NULL,	"sr",		S_INH,		0,	0x1C	},
    {	NULL,	"srl",		S_INH,		0,	0x1D	},
    {	NULL,	"rr",		S_INH,		0,	0x1E	},
    {	NULL,	"rrl",		S_INH,		0,	0x1F	},

    {	NULL,	"lde",		S_INH,		0,	0x40	},
    {	NULL,	"xae",		S_INH,		0,	0x01	},
    {	NULL,	"ane",		S_INH,		0,	0x50	},
    {	NULL,	"ore",		S_INH,		0,	0x58	},
    {	NULL,	"xre",		S_INH,		0,	0x60	},
    {	NULL,	"dae",		S_INH,		0,	0x68	},
    {	NULL,	"ade",		S_INH,		0,	0x70	},
    {	NULL,	"cae",		S_INH,		S_EOL,	0x78	}
};
