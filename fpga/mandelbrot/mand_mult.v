...
//altfp_mult CBX_AUTO_BLACKBOX="ALL" DEDICATED_MULTIPLIER_CIRCUITRY="YES" DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Cyclone IV GX" EXCEPTION_HANDLING="NO" PIPELINE=10 REDUCED_FUNCTIONALITY="NO" ROUNDING="TO_NEAREST" WIDTH_EXP=8 WIDTH_MAN=23 clock dataa datab nan overflow result underflow
//VERSION_BEGIN 16.0 cbx_alt_ded_mult_y 2016:07:20:19:14:36:SJ cbx_altbarrel_shift 2016:07:20:19:14:36:SJ cbx_altera_mult_add 2016:07:20:19:14:36:SJ cbx_altera_mult_add_rtl 2016:07:20:19:14:36:SJ cbx_altfp_mult 2016:07:20:19:14:36:SJ cbx_altmult_add 2016:07:20:19:14:36:SJ cbx_cycloneii 2016:07:20:19:14:36:SJ cbx_lpm_add_sub 2016:07:20:19:14:36:SJ cbx_lpm_compare 2016:07:20:19:14:36:SJ cbx_lpm_mult 2016:07:20:19:14:36:SJ cbx_mgl 2016:07:20:20:47:47:SJ cbx_nadder 2016:07:20:19:14:36:SJ cbx_padd 2016:07:20:19:14:36:SJ cbx_parallel_add 2016:07:20:19:14:36:SJ cbx_stratix 2016:07:20:19:14:36:SJ cbx_stratixii 2016:07:20:19:14:36:SJ cbx_util_mgl 2016:07:20:19:14:36:SJ  VERSION_END
// synthesis VERILOG_INPUT_VERSION VERILOG_2001
// altera message_off 10463


//synthesis_resources = lpm_add_sub 4 lpm_mult 1 reg 257 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  mand_mult_altfp_mult_a8q
	( 
	clock,
	dataa,
	datab,
	...
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clk_en == 1'b1)   nan_ff <= (input_is_nan_ff4 | (input_is_infinity_ff4 & (~ input_not_zero_ff4)));
	// synopsys translate_off
	initial
		overflow_ff = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clk_en == 1'b1)   overflow_ff <= (((exp_is_inf | input_is_infinity_ff4) & (~ input_is_nan_ff4)) & (~ (input_is_infinity_ff4 & (~ input_not_zero_ff4))));
	// synopsys translate_off
	initial
		round_dffe = 0;
	// synopsys translate_on
	...
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clk_en == 1'b1)   underflow_ff <= (((exp_is_zero & input_not_zero_ff4) & (~ input_is_nan_ff4)) & (~ (input_is_infinity_ff4 & (~ input_not_zero_ff4))));
...
endmodule //mand_mult_altfp_mult_a8q
//VALID FILE
...
module mand_mult (
	...
	mand_mult_altfp_mult_a8q	mand_mult_altfp_mult_a8q_component (
				.clock (clock),
				.dataa (dataa),
				.datab (datab),
				.nan (sub_wire0),
...
// Retrieval info: GEN_FILE: TYPE_NORMAL mand_mult.v TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL mand_mult.qip TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL mand_mult.bsf FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL mand_mult_inst.v FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL mand_mult_bb.v FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL mand_mult.inc FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL mand_mult.cmp FALSE TRUE
