...
set_input_delay -clock rtc_sclk_pin -min 0ns [get_ports ext_miso]
set_input_delay -clock rtc_sclk_pin -max 0ns [get_ports ext_miso]
set_output_delay -clock sd_sclk_pin -min 0ns [get_ports sd_mosi]
set_output_delay -clock sd_sclk_pin -max 0ns [get_ports sd_mosi]
set_output_delay -clock rtc_sclk_pin -min 0ns [get_ports ext_mosi]
set_output_delay -clock rtc_sclk_pin -max 0ns [get_ports ext_mosi]
set_output_delay -clock sd_sclk_pin -min 0ns [get_ports sd_ss]
set_output_delay -clock sd_sclk_pin -max 0ns [get_ports sd_ss]
set_output_delay -clock rtc_sclk_pin -min 0ns [get_ports ext_ss]
set_output_delay -clock rtc_sclk_pin -max 0ns [get_ports ext_ss]
