...
set_output_delay -clock ssram_clk_pin -max 0ns [get_ports {fl_oe_n}]
set_output_delay -clock ssram_clk_pin -min 0ns [get_ports {fl_oe_n}]
set_output_delay -clock ssram_clk_pin -max 0ns [get_ports {fl_we_n}]
set_output_delay -clock ssram_clk_pin -min 0ns [get_ports {fl_we_n}]
set_output_delay -clock ssram_clk_pin -max 0ns [get_ports {fl_ce_n}]
set_output_delay -clock ssram_clk_pin -min 0ns [get_ports {fl_ce_n}]
set_output_delay -clock ssram_clk_pin -max 0ns [get_ports {fl_rst_n}]
set_output_delay -clock ssram_clk_pin -min 0ns [get_ports {fl_rst_n}]
set_output_delay -clock ssram_clk_pin -max 0ns [get_ports {fl_wp_n}]
set_output_delay -clock ssram_clk_pin -min 0ns [get_ports {fl_wp_n}]
