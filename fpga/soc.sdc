...
create_generated_clock -name spi_sclk_reg -source pll0|altpll_component|auto_generated|pll1|clk[2] -divide_by 2 [get_registers {spi_master:spi0|spi_xcvr:xcvr0|sclk}]
create_generated_clock -name spi_sclk_pin -source [get_registers {spi_master:spi0|spi_xcvr:xcvr0|sclk}] [get_ports {sd_clk}]
set_output_delay -clock spi_sclk_pin -min 0ns [get_ports sd_mosi]
set_output_delay -clock spi_sclk_pin -max 0ns [get_ports sd_mosi]
set_output_delay -clock spi_sclk_pin -min 0ns [get_ports sd_ss]
set_output_delay -clock spi_sclk_pin -max 0ns [get_ports sd_ss]
set_output_delay -clock pll0|altpll_component|auto_generated|pll1|clk[2] -max 0ns [get_ports sd_clk]
set_output_delay -clock pll0|altpll_component|auto_generated|pll1|clk[2] -min 0ns [get_ports sd_clk]
set_input_delay -clock spi_sclk_pin -min 0ns [get_ports sd_miso]
set_input_delay -clock spi_sclk_pin -max 0ns [get_ports sd_miso]
set_input_delay -clock spi_sclk_pin -min 0ns [get_ports sd_wp_n]
set_input_delay -clock spi_sclk_pin -max 0ns [get_ports sd_wp_n]
...
set_input_delay -clock ssram_clk -max 3.1ns [get_ports {fs_databus*}]
set_input_delay -clock ssram_clk -min 0ns [get_ports {fs_databus*}]
set_output_delay -clock ssram_clk -max 1.4ns [get_ports {fs_databus*}]
set_output_delay -clock ssram_clk -min -0.4ns [get_ports {fs_databus*}]
set_output_delay -clock ssram_clk -max 1.4ns [get_ports {fs_addrbus*}]
set_output_delay -clock ssram_clk -min -0.4ns [get_ports {fs_addrbus*}]
set_output_delay -clock ssram_clk -max 1.4ns [get_ports ssram0_ce_n]
set_output_delay -clock ssram_clk -min -0.4ns [get_ports ssram0_ce_n]
set_output_delay -clock ssram_clk -max 1.4ns [get_ports ssram1_ce_n]
set_output_delay -clock ssram_clk -min -0.4ns [get_ports ssram1_ce_n]
set_output_delay -clock ssram_clk -max 1.4ns [get_ports ssram_we_n]
set_output_delay -clock ssram_clk -min -0.4ns [get_ports ssram_we_n]
set_output_delay -clock ssram_clk -max 1.4ns [get_ports ssram_gw_n]
set_output_delay -clock ssram_clk -min -0.4ns [get_ports ssram_gw_n]
set_output_delay -clock ssram_clk -max 1.4ns [get_ports {ssram_be*}]
set_output_delay -clock ssram_clk -min -0.4ns [get_ports {ssram_be*}]
set_output_delay -clock ssram_clk -max 1.4ns [get_ports ssram_oe_n]
set_output_delay -clock ssram_clk -min -0.4ns [get_ports ssram_oe_n]
set_output_delay -clock ssram_clk -max 1.4ns [get_ports ssram_adsp_n]
set_output_delay -clock ssram_clk -min -0.4ns [get_ports ssram_adsp_n]
