...
module  fp_cvtsi_altbarrel_shift_s3g
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //fp_cvtsi_altbarrel_shift_s3g

//synthesis_resources = lpm_add_sub 5 lpm_compare 4 reg 281 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_cvtsi_altfp_convert_f5n
	( 
	clock,
	dataa,
	result) ;
	...
	fp_cvtsi_altbarrel_shift_s3g   altbarrel_shift6
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
...
endmodule //fp_cvtsi_altfp_convert_f5n
//VALID FILE
...
module fp_cvtsi (
	...
	fp_cvtsi_altfp_convert_f5n	fp_cvtsi_altfp_convert_f5n_component (
				.clock (clock),
				.dataa (dataa),
				.result (sub_wire0));
