...
//altfp_add_sub CBX_AUTO_BLACKBOX="ALL" DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Cyclone II" DIRECTION="VARIABLE" OPTIMIZE="SPEED" PIPELINE=10 REDUCED_FUNCTIONALITY="NO" WIDTH_EXP=8 WIDTH_MAN=23 add_sub clock dataa datab overflow result underflow zero
...
module  fpaddsub_altbarrel_shift_h0e
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //fpaddsub_altbarrel_shift_h0e
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fpaddsub_altbarrel_shift_6hb
	( 
	data,
	distance,
	result) ;
	...
	assign
		...
		sel_w = {distance[4:0]},
		smux_w = {((({26{(sel_w[4] & (~ dir_w[4]))}} & {sbit_w[113:104], pad_w[15:0]}) | ({26{(sel_w[4] & dir_w[4])}} & {pad_w[15:0], sbit_w[129:120]})) | ({26{(~ sel_w[4])}} & sbit_w[129:104])), ((({26{(sel_w[3] & (~ dir_w[3]))}} & {sbit_w[95:78], pad_w[7:0]}) | ({26{(sel_w[3] & dir_w[3])}} & {pad_w[7:0], sbit_w[103:86]})) | ({26{(~ sel_w[3])}} & sbit_w[103:78])), ((({26{(sel_w[2] & (~ dir_w[2]))}} & {sbit_w[73:52], pad_w[3:0]}) | ({26{(sel_w[2] & dir_w[2])}} & {pad_w[3:0], sbit_w[77:56]})) | ({26{(~ sel_w[2])}} & sbit_w[77:52])), ((({26{(sel_w[1] & (~ dir_w[1]))}} & {sbit_w[49:26], pad_w[1:0]}) | ({26{(sel_w[1] & dir_w[1])}} & {pad_w[1:0], sbit_w[51:28]})) | ({26{(~ sel_w[1])}} & sbit_w[51:26])), ((({26{(sel_w[0] & (~ dir_w[0]))}} & {sbit_w[24:0], pad_w[0]}) | ({26{(sel_w[0] & dir_w[0])}} & {pad_w[0], sbit_w[25:1]})) | ({26{(~ sel_w[0])}} & sbit_w[25:0]))};
endmodule //fpaddsub_altbarrel_shift_6hb
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fpaddsub_altpriority_encoder_uv8
	( 
	data,
	q) ;
	input   [15:0]  data;
...
endmodule //fpaddsub_altpriority_encoder_uv8
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fpaddsub_altpriority_encoder_ue9
	( 
	data,
	q,
	zero) ;
...
endmodule //fpaddsub_altpriority_encoder_ue9

//synthesis_resources = reg 5 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fpaddsub_altpriority_encoder_ou8
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	fpaddsub_altpriority_encoder_uv8   altpriority_encoder7
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder7_q));
	fpaddsub_altpriority_encoder_ue9   altpriority_encoder8
	( 
	.data(data[31:16]),
...
endmodule //fpaddsub_altpriority_encoder_ou8
...
//synthesis_resources = lpm_add_sub 14 lpm_compare 1 reg 511 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fpaddsub_altfp_add_sub_mlm
	( 
	add_sub,
	clock,
	dataa,
...
`endif
	...
	fpaddsub_altbarrel_shift_h0e   lbarrel_shift
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	fpaddsub_altbarrel_shift_6hb   rbarrel_shift
	( 
	.data({man_smaller_dffe13_wo, {2{1'b0}}}),
	.distance(rshift_distance_dffe13_wo),
	.result(wire_rbarrel_shift_result));
	fpaddsub_altpriority_encoder_ou8   leading_zeroes_cnt
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
...
endmodule //fpaddsub_altfp_add_sub_mlm
//VALID FILE
...
module fpaddsub (
	...
	fpaddsub_altfp_add_sub_mlm	fpaddsub_altfp_add_sub_mlm_component (
				.add_sub (add_sub),
				.clock (clock),
				.datab (datab),
				.dataa (dataa),
