...
# Thu Feb 26 08:35:57 EST 2015
# DO NOT MODIFY


# 
# bexkat1 "bexkat1" v1.1
# Matt Stock 2015.02.26.08:35:57
# Bexkat1 CPU with LE avalon swapping
# 
...
# module bexkat1
# 
set_module_property DESCRIPTION "Bexkat1 CPU with LE avalon swapping"
...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL bexkat1_le
...
add_fileset_file bexkat1.v VERILOG PATH cpu/bexkat1.v
add_fileset_file registerfile.v VERILOG PATH cpu/registerfile.v
add_fileset_file bexkat1_le.v VERILOG PATH cpu/bexkat1_le.v TOP_LEVEL_FILE
