...
module  fp_cvtsi_altbarrel_shift_grf
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //fp_cvtsi_altbarrel_shift_grf

//synthesis_resources = lpm_add_sub 5 lpm_compare 4 reg 281 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_cvtsi_altfp_convert_3tm
	( 
	clock,
	dataa,
	result) ;
	...
	fp_cvtsi_altbarrel_shift_grf   altbarrel_shift6
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
...
endmodule //fp_cvtsi_altfp_convert_3tm
//VALID FILE
...
module fp_cvtsi (
	...
	fp_cvtsi_altfp_convert_3tm	fp_cvtsi_altfp_convert_3tm_component (
				.clock (clock),
				.dataa (dataa),
				.result (sub_wire0));
...
// Retrieval info: GEN_FILE: TYPE_NORMAL fp_cvtsi_bb.v FALSE TRUE
