...
//altfp_sqrt CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone II" PIPELINE=16 ROUNDING="TO_NEAREST" WIDTH_EXP=8 WIDTH_MAN=23 aclr clock data overflow result
//VERSION_BEGIN 12.1SP1 cbx_altfp_sqrt 2013:01:31:18:04:55:SJ cbx_cycloneii 2013:01:31:18:04:55:SJ cbx_lpm_add_sub 2013:01:31:18:04:55:SJ cbx_mgl 2013:01:31:18:08:38:SJ cbx_stratix 2013:01:31:18:04:55:SJ cbx_stratixii 2013:01:31:18:04:55:SJ  VERSION_END
...
module  fp_sqrt_alt_sqrt_block_kfb
	( 
	aclr,
	clken,
	clock,
...
endmodule //fp_sqrt_alt_sqrt_block_kfb

//synthesis_resources = lpm_add_sub 27 reg 762 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_sqrt_altfp_sqrt_j0e
	( 
	aclr,
	clock,
	data,
...
`endif
	...
	fp_sqrt_alt_sqrt_block_kfb   alt_sqrt_block2
	( 
	.aclr(aclr),
	.clken(clk_en),
	.clock(clock),
...
endmodule //fp_sqrt_altfp_sqrt_j0e
//VALID FILE
...
module fp_sqrt (
	...
	fp_sqrt_altfp_sqrt_j0e	fp_sqrt_altfp_sqrt_j0e_component (
				.aclr (aclr),
				.clock (clock),
				.data (data),
				.overflow (sub_wire0),
