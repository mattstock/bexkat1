...
//altfp_mult CBX_AUTO_BLACKBOX="ALL" DEDICATED_MULTIPLIER_CIRCUITRY="YES" DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Cyclone II" EXCEPTION_HANDLING="NO" PIPELINE=6 REDUCED_FUNCTIONALITY="NO" ROUNDING="TO_NEAREST" WIDTH_EXP=8 WIDTH_MAN=23 aclr clock dataa datab nan overflow result underflow
//VERSION_BEGIN 12.1SP1 cbx_alt_ded_mult_y 2013:01:31:18:04:54:SJ cbx_altbarrel_shift 2013:01:31:18:04:54:SJ cbx_altera_mult_add 2013:01:31:18:04:54:SJ cbx_altfp_mult 2013:01:31:18:04:55:SJ cbx_altmult_add 2013:01:31:18:04:55:SJ cbx_cycloneii 2013:01:31:18:04:55:SJ cbx_lpm_add_sub 2013:01:31:18:04:55:SJ cbx_lpm_compare 2013:01:31:18:04:55:SJ cbx_lpm_mult 2013:01:31:18:04:55:SJ cbx_mgl 2013:01:31:18:08:38:SJ cbx_padd 2013:01:31:18:04:55:SJ cbx_parallel_add 2013:01:31:18:04:55:SJ cbx_stratix 2013:01:31:18:04:55:SJ cbx_stratixii 2013:01:31:18:04:55:SJ cbx_util_mgl 2013:01:31:18:04:55:SJ  VERSION_END
// synthesis VERILOG_INPUT_VERSION VERILOG_2001
// altera message_off 10463


//synthesis_resources = lpm_add_sub 4 lpm_mult 1 reg 153 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_mult_altfp_mult_lcq
	( 
	aclr,
	clock,
	dataa,
...
`endif
	...
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clk_en == 1'b1)   exp_result_ff <= ((inf_num & {8{((exp_is_inf | input_is_infinity_ff2) | input_is_nan_ff2)}}) | ((wire_exp_adj_adder_result[7:0] & {8{(~ exp_is_zero)}}) & {8{input_not_zero_ff2}}));
	// synopsys translate_off
	initial
	...
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clk_en == 1'b1)   man_result_ff <= {((((((delay_round_wire[22] & input_not_zero_ff2) & (~ input_is_infinity_ff2)) & (~ exp_is_inf)) & (~ exp_is_zero)) | (input_is_infinity_ff2 & (~ input_not_zero_ff2))) | input_is_nan_ff2), (((((delay_round_wire[21:0] & {22{input_not_zero_ff2}}) & {22{(~ input_is_infinity_ff2)}}) & {22{(~ exp_is_inf)}}) & {22{(~ exp_is_zero)}}) & {22{(~ input_is_nan_ff2)}})};
	// synopsys translate_off
	initial
		man_round_p = 0;
	// synopsys translate_on
	...
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clk_en == 1'b1)   nan_ff <= (input_is_nan_ff2 | (input_is_infinity_ff2 & (~ input_not_zero_ff2)));
	// synopsys translate_off
	initial
		overflow_ff = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clk_en == 1'b1)   overflow_ff <= (((exp_is_inf | input_is_infinity_ff2) & (~ input_is_nan_ff2)) & (~ (input_is_infinity_ff2 & (~ input_not_zero_ff2))));
	// synopsys translate_off
	initial
		round_dffe = 0;
	// synopsys translate_on
	...
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clk_en == 1'b1)   underflow_ff <= (((exp_is_zero & input_not_zero_ff2) & (~ input_is_nan_ff2)) & (~ (input_is_infinity_ff2 & (~ input_not_zero_ff2))));
	...
	assign
		...
		delay_round_wire = ((man_round_p2[23:0] & {24{(~ man_round_p2[24])}}) | (man_round_p2[24:1] & {24{man_round_p2[24]}})),
		...
		result = {sign_node_ff5[0:0], exp_result_ff[7:0], man_result_ff[22:0]},
...
endmodule //fp_mult_altfp_mult_lcq
//VALID FILE
...
module fp_mult (
	...
	fp_mult_altfp_mult_lcq	fp_mult_altfp_mult_lcq_component (
				.aclr (aclr),
				.clock (clock),
				.datab (datab),
				.dataa (dataa),
