...
//altfp_add_sub CBX_AUTO_BLACKBOX="ALL" DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Cyclone II" DIRECTION="VARIABLE" OPTIMIZE="AREA" PIPELINE=7 REDUCED_FUNCTIONALITY="NO" WIDTH_EXP=8 WIDTH_MAN=23 aclr add_sub clock dataa datab nan overflow result underflow
//VERSION_BEGIN 12.1SP1 cbx_altbarrel_shift 2013:01:31:18:04:54:SJ cbx_altfp_add_sub 2013:01:31:18:04:54:SJ cbx_altpriority_encoder 2013:01:31:18:04:55:SJ cbx_cycloneii 2013:01:31:18:04:55:SJ cbx_lpm_add_sub 2013:01:31:18:04:55:SJ cbx_lpm_compare 2013:01:31:18:04:55:SJ cbx_mgl 2013:01:31:18:08:38:SJ cbx_stratix 2013:01:31:18:04:55:SJ cbx_stratixii 2013:01:31:18:04:55:SJ  VERSION_END
...
//VERSION_BEGIN 12.1SP1 cbx_altbarrel_shift 2013:01:31:18:04:54:SJ cbx_mgl 2013:01:31:18:08:38:SJ  VERSION_END

//synthesis_resources = reg 27 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_addsub_altbarrel_shift_h0e
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //fp_addsub_altbarrel_shift_h0e
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_addsub_altbarrel_shift_6hb
	( 
	data,
	distance,
	result) ;
	...
	assign
		...
		sel_w = {distance[4:0]},
		smux_w = {((({26{(sel_w[4] & (~ dir_w[4]))}} & {sbit_w[113:104], pad_w[15:0]}) | ({26{(sel_w[4] & dir_w[4])}} & {pad_w[15:0], sbit_w[129:120]})) | ({26{(~ sel_w[4])}} & sbit_w[129:104])), ((({26{(sel_w[3] & (~ dir_w[3]))}} & {sbit_w[95:78], pad_w[7:0]}) | ({26{(sel_w[3] & dir_w[3])}} & {pad_w[7:0], sbit_w[103:86]})) | ({26{(~ sel_w[3])}} & sbit_w[103:78])), ((({26{(sel_w[2] & (~ dir_w[2]))}} & {sbit_w[73:52], pad_w[3:0]}) | ({26{(sel_w[2] & dir_w[2])}} & {pad_w[3:0], sbit_w[77:56]})) | ({26{(~ sel_w[2])}} & sbit_w[77:52])), ((({26{(sel_w[1] & (~ dir_w[1]))}} & {sbit_w[49:26], pad_w[1:0]}) | ({26{(sel_w[1] & dir_w[1])}} & {pad_w[1:0], sbit_w[51:28]})) | ({26{(~ sel_w[1])}} & sbit_w[51:26])), ((({26{(sel_w[0] & (~ dir_w[0]))}} & {sbit_w[24:0], pad_w[0]}) | ({26{(sel_w[0] & dir_w[0])}} & {pad_w[0], sbit_w[25:1]})) | ({26{(~ sel_w[0])}} & sbit_w[25:0]))};
endmodule //fp_addsub_altbarrel_shift_6hb


//altpriority_encoder CBX_AUTO_BLACKBOX="ALL" WIDTH=32 WIDTHAD=5 data q
//VERSION_BEGIN 12.1SP1 cbx_altpriority_encoder 2013:01:31:18:04:55:SJ cbx_mgl 2013:01:31:18:08:38:SJ  VERSION_END
...
module  fp_addsub_altpriority_encoder_6v7
	...
	fp_addsub_altpriority_encoder_3v7   altpriority_encoder16
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder16_q));
	fp_addsub_altpriority_encoder_3e8   altpriority_encoder17
	( 
	.data(data[3:2]),
...
module  fp_addsub_altpriority_encoder_6e8
	...
	fp_addsub_altpriority_encoder_3e8   altpriority_encoder18
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder18_q),
	.zero(wire_altpriority_encoder18_zero));
	fp_addsub_altpriority_encoder_3e8   altpriority_encoder19
	( 
	.data(data[3:2]),
...
module  fp_addsub_altpriority_encoder_bv7
	...
	fp_addsub_altpriority_encoder_6v7   altpriority_encoder14
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder14_q));
	fp_addsub_altpriority_encoder_6e8   altpriority_encoder15
	( 
	.data(data[7:4]),
...
module  fp_addsub_altpriority_encoder_be8
	...
	fp_addsub_altpriority_encoder_6e8   altpriority_encoder21
	( 
	.data(data[7:4]),
	.q(wire_altpriority_encoder21_q),
	.zero(wire_altpriority_encoder21_zero));
	assign
		q = {(~ wire_altpriority_encoder21_zero), (({2{wire_altpriority_encoder21_zero}} & wire_altpriority_encoder20_q) | ({2{(~ wire_altpriority_encoder21_zero)}} & wire_altpriority_encoder21_q))},
...
module  fp_addsub_altpriority_encoder_r08
	...
	fp_addsub_altpriority_encoder_bv7   altpriority_encoder12
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder12_q));
	fp_addsub_altpriority_encoder_be8   altpriority_encoder13
	( 
	.data(data[15:8]),
	.q(wire_altpriority_encoder13_q),
	.zero(wire_altpriority_encoder13_zero));
	assign
		q = {(~ wire_altpriority_encoder13_zero), (({3{wire_altpriority_encoder13_zero}} & wire_altpriority_encoder12_q) | ({3{(~ wire_altpriority_encoder13_zero)}} & wire_altpriority_encoder13_q))};
...
module  fp_addsub_altpriority_encoder_rf8
	...
	fp_addsub_altpriority_encoder_be8   altpriority_encoder22
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder22_q),
	.zero(wire_altpriority_encoder22_zero));
	fp_addsub_altpriority_encoder_be8   altpriority_encoder23
	( 
	.data(data[15:8]),
	.q(wire_altpriority_encoder23_q),
	.zero(wire_altpriority_encoder23_zero));
	assign
		q = {(~ wire_altpriority_encoder23_zero), (({3{wire_altpriority_encoder23_zero}} & wire_altpriority_encoder22_q) | ({3{(~ wire_altpriority_encoder23_zero)}} & wire_altpriority_encoder23_q))},
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_addsub_altpriority_encoder_qb6
	( 
	data,
	q) ;
	input   [31:0]  data;
	...
	fp_addsub_altpriority_encoder_r08   altpriority_encoder10
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder10_q));
	fp_addsub_altpriority_encoder_rf8   altpriority_encoder11
	( 
	.data(data[31:16]),
	.q(wire_altpriority_encoder11_q),
	.zero(wire_altpriority_encoder11_zero));
	assign
		q = {(~ wire_altpriority_encoder11_zero), (({4{wire_altpriority_encoder11_zero}} & wire_altpriority_encoder10_q) | ({4{(~ wire_altpriority_encoder11_zero)}} & wire_altpriority_encoder11_q))};
endmodule //fp_addsub_altpriority_encoder_qb6
...
module  fp_addsub_altpriority_encoder_qh8
	...
	wire  [0:0]   wire_altpriority_encoder30_q;
	wire  wire_altpriority_encoder30_zero;
	wire  [0:0]   wire_altpriority_encoder31_q;
	wire  wire_altpriority_encoder31_zero;

	fp_addsub_altpriority_encoder_nh8   altpriority_encoder30
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder30_q),
	.zero(wire_altpriority_encoder30_zero));
	fp_addsub_altpriority_encoder_nh8   altpriority_encoder31
	( 
	.data(data[3:2]),
	.q(wire_altpriority_encoder31_q),
	.zero(wire_altpriority_encoder31_zero));
	assign
		q = {wire_altpriority_encoder30_zero, ((wire_altpriority_encoder30_zero & wire_altpriority_encoder31_q) | ((~ wire_altpriority_encoder30_zero) & wire_altpriority_encoder30_q))},
...
module  fp_addsub_altpriority_encoder_vh8
	...
	wire  [1:0]   wire_altpriority_encoder28_q;
	wire  wire_altpriority_encoder28_zero;
	wire  [1:0]   wire_altpriority_encoder29_q;
	wire  wire_altpriority_encoder29_zero;

	fp_addsub_altpriority_encoder_qh8   altpriority_encoder28
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder28_q),
	.zero(wire_altpriority_encoder28_zero));
	fp_addsub_altpriority_encoder_qh8   altpriority_encoder29
	( 
	.data(data[7:4]),
	.q(wire_altpriority_encoder29_q),
	.zero(wire_altpriority_encoder29_zero));
	assign
		q = {wire_altpriority_encoder28_zero, (({2{wire_altpriority_encoder28_zero}} & wire_altpriority_encoder29_q) | ({2{(~ wire_altpriority_encoder28_zero)}} & wire_altpriority_encoder28_q))},
		zero = (wire_altpriority_encoder28_zero & wire_altpriority_encoder29_zero);
...
module  fp_addsub_altpriority_encoder_fj8
	...
	wire  [2:0]   wire_altpriority_encoder26_q;
	wire  wire_altpriority_encoder26_zero;
	wire  [2:0]   wire_altpriority_encoder27_q;
	wire  wire_altpriority_encoder27_zero;

	fp_addsub_altpriority_encoder_vh8   altpriority_encoder26
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder26_q),
	.zero(wire_altpriority_encoder26_zero));
	fp_addsub_altpriority_encoder_vh8   altpriority_encoder27
	( 
	.data(data[15:8]),
	.q(wire_altpriority_encoder27_q),
	.zero(wire_altpriority_encoder27_zero));
	assign
		q = {wire_altpriority_encoder26_zero, (({3{wire_altpriority_encoder26_zero}} & wire_altpriority_encoder27_q) | ({3{(~ wire_altpriority_encoder26_zero)}} & wire_altpriority_encoder26_q))},
...
module  fp_addsub_altpriority_encoder_q28
	...
	fp_addsub_altpriority_encoder_nh8   altpriority_encoder36
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder36_q),
	.zero(wire_altpriority_encoder36_zero));
	fp_addsub_altpriority_encoder_n28   altpriority_encoder37
	( 
	.data(data[3:2]),
...
module  fp_addsub_altpriority_encoder_v28
	...
	fp_addsub_altpriority_encoder_qh8   altpriority_encoder34
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder34_q),
	.zero(wire_altpriority_encoder34_zero));
	fp_addsub_altpriority_encoder_q28   altpriority_encoder35
	( 
	.data(data[7:4]),
...
module  fp_addsub_altpriority_encoder_f48
	...
	fp_addsub_altpriority_encoder_vh8   altpriority_encoder32
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder32_q),
	.zero(wire_altpriority_encoder32_zero));
	fp_addsub_altpriority_encoder_v28   altpriority_encoder33
	( 
	.data(data[15:8]),
...
module  fp_addsub_altpriority_encoder_e48
	...
	fp_addsub_altpriority_encoder_fj8   altpriority_encoder24
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder24_q),
	.zero(wire_altpriority_encoder24_zero));
	fp_addsub_altpriority_encoder_f48   altpriority_encoder25
	( 
	.data(data[31:16]),
...
//synthesis_resources = lpm_add_sub 9 lpm_compare 1 reg 286 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_addsub_altfp_add_sub_jqm
	( 
	aclr,
	add_sub,
	clock,
...
`endif
	...
	wire  [27:0]   wire_add_sub4_result;
	wire  [27:0]   wire_add_sub5_result;
	wire  [8:0]   wire_add_sub6_result;
	wire  [8:0]   wire_add_sub7_result;
	...
	fp_addsub_altbarrel_shift_h0e   lbarrel_shift
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	fp_addsub_altbarrel_shift_6hb   rbarrel_shift
	( 
	.data({man_smaller_dffe13_wo, {2{1'b0}}}),
	.distance(rshift_distance_dffe13_wo),
	.result(wire_rbarrel_shift_result));
	fp_addsub_altpriority_encoder_qb6   leading_zeroes_cnt
	( 
	.data({man_add_sub_res_mag_dffe21_wo[25:1], 1'b1, {6{1'b0}}}),
	.q(wire_leading_zeroes_cnt_q));
	fp_addsub_altpriority_encoder_e48   trailing_zeros_cnt
	( 
	...
	defparam
		...
		add_sub4.lpm_width = 28,
		add_sub4.lpm_type = "lpm_add_sub",
		add_sub4.lpm_hint = "USE_WYS=ON";
	...
	defparam
		...
		add_sub7.lpm_representation = "SIGNED",
		add_sub7.lpm_width = 9,
		add_sub7.lpm_type = "lpm_add_sub",
		add_sub7.lpm_hint = "USE_WYS=ON";
	...
	defparam
		...
		add_sub8.lpm_representation = "SIGNED",
		add_sub8.lpm_width = 26,
...
endmodule //fp_addsub_altfp_add_sub_jqm
//VALID FILE
...
module fp_addsub (
	...
	fp_addsub_altfp_add_sub_jqm	fp_addsub_altfp_add_sub_jqm_component (
				.clock (clock),
				.datab (datab),
				.dataa (dataa),
				.aclr (aclr),
...
// Retrieval info: GEN_FILE: TYPE_NORMAL fp_addsub_bb.v FALSE
